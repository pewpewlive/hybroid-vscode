...
- `src/test/`: Contains integration tests that run in a separate VS Code instance.
- `testFixture/`: Sample Hybroid files used for testing.
...
- **Test**: `npm test` (Runs integration tests via `src/test/runTest.ts`)
